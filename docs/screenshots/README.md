...
Place demo captures here and reference them from the README:

| File | What to capture |
| --- | --- |
| `overview.png` | Overview tab after **Run Attack Sequence**: Protection ACTIVE, stat cards, the *Potential secret exfiltration* incident with the attack chain (File read BLOCKED → Network BLOCKED → Risk 100 / CRITICAL) |
| `activity.png` | Activity tab with the BLOCKED SSH-key read selected and its risk factors visible |
...
Do not add screenshots of behaviour that is not implemented.
